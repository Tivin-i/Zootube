...
import { createAuthUrl, createSignedState } from "@/lib/services/youtube-oauth.service";
import { householdIdSchema } from "@/lib/validators/household.validator";
import { ValidationError } from "@/lib/errors/app-errors";
import crypto from "crypto";

/**
 * GET /api/auth/youtube?household_id=xxx
 * Redirects to Google OAuth. Caller must be authenticated and a member of the household.
 */
